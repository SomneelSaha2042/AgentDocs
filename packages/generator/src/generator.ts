...
- **Retrieve context once**: Call retrieval/MCP tools (like \`get_task_context\` or \`search_docs\` + \`get_page\`) early in Turn 1 or Turn 2 to build your task context and plan.
