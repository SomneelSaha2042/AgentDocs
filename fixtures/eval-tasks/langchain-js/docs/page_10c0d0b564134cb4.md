...
Array of all pending queue entries
...
Cancel a specific queued entry by ID
...
The input values (including messages) that were submitted

`options`

`object`

Any additional options passed with the submission
