...
Auth.js supports 2 session strategies to persist the login state of a user. The default is to use a cookie + [JWT](https://authjs.dev/concepts/session-strategies#jwt-session) based session store (`strategy: "jwt"`), but you can also use a database adapter to store the session in a database.

Before you continue, Auth.js has a list of [official database adapters](https://adapters.authjs.dev). If your database is listed there, you probably do not need to create your own. If you are using a data solution that cannot be integrated with an official adapter, this module will help you create a compatible adapter.

⚠️

**Note** Although `@auth/core` *is* framework/runtime agnostic, an adapter might rely on a client/ORM package, that is not yet compatible with your framework/runtime (e.g. it might rely on [Node.js APIs](https://nodejs.org/docs/latest/api)). Related issues should be reported to the corresponding package maintainers.
...
Each adapter method and its function signature is documented in the [Adapter](adapters#adapter) interface.
...
There is a test suite [available](https://github.com/nextauthjs/next-auth/blob/main/packages/utils/adapter.ts) to ensure that your adapter is compatible with Auth.js.
...
Auth.js *currently* does not support [\`access\_token\` rotation](https://authjs.dev/concepts/oauth) out of the box. The necessary information (`refresh_token`, expiry, etc.) is being stored in the database, but the logic to rotate the token is not implemented in the core library. [This guide](https://authjs.dev/guides/refresh-token-rotation#database-strategy) should provide the necessary steps to do this in user land.
...
[`Awaitable`](types#awaitablet)<[`AdapterAuthenticator`](adapters#adapterauthenticator)\>
...
[`Awaitable`](types#awaitablet)<[`AdapterSession`](adapters#adaptersession)\>
...
[`Awaitable`](types#awaitablet)<[`AdapterUser`](adapters#adapteruser)\>
...
[`Awaitable`](types#awaitablet)<`undefined` | `null` | [`VerificationToken`](adapters#verificationtoken)\>
...
| [`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)<`void`\> | [`Awaitable`](types#awaitablet)<`undefined` | `null` | [`AdapterSession`](adapters#adaptersession)\>
...
| [`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)<`void`\> | [`Awaitable`](types#awaitablet)<`undefined` | `null` | [`AdapterUser`](adapters#adapteruser)\>
...
[`Awaitable`](types#awaitablet)<`null` | [`AdapterAccount`](adapters#adapteraccount)\>
...
[`Awaitable`](types#awaitablet)<`null` | [`AdapterAuthenticator`](adapters#adapterauthenticator)\>
...
[`Awaitable`](types#awaitablet)< | `null` | { `session`: [`AdapterSession`](adapters#adaptersession); `user`: [`AdapterUser`](adapters#adapteruser); }>
...
[`Awaitable`](types#awaitablet)<`null` | [`AdapterUser`](adapters#adapteruser)\>
...
| [`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)<`void`\> | [`Awaitable`](types#awaitablet)<`undefined` | `null` | [`AdapterAccount`](adapters#adapteraccount)\>
...
| [`Promise`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Promise)<`void`\> | [`Awaitable`](types#awaitablet)<`undefined` | [`AdapterAccount`](adapters#adapteraccount)\>
...
[`Awaitable`](types#awaitablet)<`undefined` | `null` | [`AdapterSession`](adapters#adaptersession)\>
...
[`Awaitable`](types#awaitablet)<`null` | [`VerificationToken`](adapters#verificationtoken)\>
...
[`Account`](types#account).[`access_token`](types#access_token)
...
[`Account`](types#account).[`authorization_details`](types#authorization_details)
...
[`Account`](types#account).[`expires_at`](types#expires_at)
...
[`Account`](types#account).[`expires_in`](types#expires_in)
...
[`Account`](types#account).[`id_token`](types#id_token)
...
[`Account`](types#account).[`provider`](types#provider)
...
[`Account`](types#account).[`providerAccountId`](types#provideraccountid)
...
[`Account`](types#account).[`refresh_token`](types#refresh_token)
...
[`Account`](types#account).[`scope`](types#scope)
...
[`Account`](types#account).[`token_type`](types#token_type)
...
[`Account`](types#account).[`type`](types#type)
...
[`Account`](types#account).[`userId`](types#userid)
...
[`Authenticator`](types#authenticator).[`counter`](types#counter)
...
[`Authenticator`](types#authenticator).[`credentialBackedUp`](types#credentialbackedup)
...
[`Authenticator`](types#authenticator).[`credentialDeviceType`](types#credentialdevicetype)
...
[`Authenticator`](types#authenticator).[`credentialID`](types#credentialid)
...
[`Authenticator`](types#authenticator).[`credentialPublicKey`](types#credentialpublickey)
...
[`Authenticator`](types#authenticator).[`providerAccountId`](types#provideraccountid-1)
...
[`Authenticator`](types#authenticator).[`transports`](types#transports)
...
[`Authenticator`](types#authenticator).[`userId`](types#userid-1)
...
[`User`](types#user-2).[`email`](types#email-2)
...
[`User`](types#user-2).[`id`](types#id-3)
...
[`User`](types#user-2).[`image`](types#image-1)
...
[`User`](types#user-2).[`name`](types#name-4)
...
[@auth/core](/reference/core "@auth/core")[errors](/reference/core/errors "errors")
